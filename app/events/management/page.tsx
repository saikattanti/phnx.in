...
const managementEvents = [
  { id: "Pitchers", name: "the Pitchers", image: "/events/business-strategy.jpg" },
];

export default function ManagementPage() {
  return (
    <div className="min-h-screen bg-[#121212] flex flex-col justify-center items-center pt-20">
      <Head>
        <title>Management Events | Phoenix '25</title>
      </Head>
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-lg md:text-xl text-gray-400 max-w-3xl mx-auto">
              Showcase your business acumen and strategic thinking!
            </p>
          </motion.div>
        </div>
      </section>
          ...
          >
            ...
            <div className="relative h-full flex flex-col justify-end p-6 z-10 text-center">
              ...
              <div className="grid grid-cols-2 gap-3 mt-4">
                <Link
                  href={`/events/management/${event.id}`}
                ...
                <Link
                  href={`/events/management/${event.id}/register`}
