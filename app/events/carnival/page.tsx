...
export default function CarnivalPage() {
  return (
    <div className="min-h-screen flex flex-col items-center justify-center px-6 md:px-12 text-white pt-24">
      {/* Title */}
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
        {carnivalEvents.map((event) => (
          <motion.div
            key={event.id}
            className="relative rounded-lg shadow-lg overflow-hidden w-72 h-72 flex flex-col items-center justify-center"
